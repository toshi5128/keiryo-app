...
| v4 | 中身 |
|---|---|
| §4 標準メニュー | そぼろ120g+卵1個+ご飯170g+オイル6g ×3食＋プロテイン2杯。今日画面からワンタップ記録 |
...
| 箇所 | 引き継ぎ書 | 実際に計算した値 | 扱い |
|---|---|---|---|
| §4 標準メニュー1日 | 2,170kcal | **2,038kcal** | 同じ表の「1食599×3＋プロテイン240」と合わない。食材マスタを正とした |
| §4 標準メニュー1食の塩分 | 1.0g | **1.16g** | 卵の0.2gが数えられていない |
| §4 標準メニュー1日のF | 57g | **52.5g** | 下限58gを割るので、オイルかご飯で補う必要がある |

**標準メニューだけでは 2,200kcal に約160kcal 足りず、脂質も下限を5.5g割る。**
ご飯を1食あたり30g増やす（+47kcal×3＝141kcal）か、オイルを1食9gにすると収まる。
どちらにするかは本人に確認すること。数値は勝手に変えていない。
