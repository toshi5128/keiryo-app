...
describe('8/17 の実シナリオ', () => {
  it('基準（1食目のあと残り2食）', () => {
    ...
    expect(render(r)).toMatchInlineSnapshot(`
      ...
      1食目 P55.1 699kcal: 鶏もも肉200g・白米200g・卵1個・ブロッコリー150g・オリーブオイル1小さじ
  ...
  it('鶏ももが在庫切れ', () => {
    ...
    expect(render(r)).toMatchInlineSnapshot(`
      ...
      1食目 P55.9 709kcal: 鶏そぼろ180g・白米170g・卵1個・ブロッコリー150g・オリーブオイル2小さじ
      2食目 P61.0 825kcal: 鶏そぼろ180g・白米200g・卵1個・茎わかめ醤油漬100g・オクラ50g・納豆1P・オリーブオイル1小さじ"
    `)
  })
  ...
  it('羊羹1切れを食べたい', () => {
    ...
    expect(render(r)).toMatchInlineSnapshot(`
      ...
      1食目 P54.8 627kcal: 鶏もも肉205g・白米150g・卵1個・ブロッコリー150g・オリーブオイル1小さじ
  ...
  it('起床が20時（残り1食）', () => {
    ...
    expect(render(r) + '\n' + r.notes.join('\n')).toMatchInlineSnapshot(`
      ...
      1食目 P75.7 1200kcal: 鶏もも肉250g・白米350g・卵1個・ブロッコリー150g・納豆1P・オリーブオイル4小さじ
